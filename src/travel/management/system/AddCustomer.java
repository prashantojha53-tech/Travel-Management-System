...
//        lblusername = new JLabel();   // line me "Name" add larna he
...
//        add(lblname);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            if (username.equals("") || name.equals("") || number.equals("")
                    || gender == null || country.equals("") || address.equals("")
            ...
            try {
                ...
                String checkQuery = "SELECT * FROM customer WHERE username = '" + username + "'";
                ResultSet rs = c.s.executeQuery(checkQuery);

                String query = "INSERT INTO customer(id, username, name, country, phone, email, number, gender, address) VALUES('"
                        + id + "', '"
                        + username + "', '"
                        + name + "', '"
                        + country + "', '"
...
//            }
                ...
                try {
                    c.s.executeUpdate(query);   // ✅ yahan run hoga
