...
//        setLayout(null);   useless

    String[] package1 = {"GOLD PACKAGE", "6  Days and 7 Nights", "Airport Assistence" , "Half Day City Tour","Daily Buffet","Soft Drink Free","Full Day 3 Iseland Cruise","English Speaking Guide","Summer Speacial","BOOK PACKAGE","Rs 12000/-","package1.jpg"};
    String[] package2 = {"SILVER PACKAGE", "6  Days and 7 Nights", "Toll Free "," Entrance Free Ticket", "Meet and Greet at Airport", "Welcome Drinks on Arrival","Night Safari","Criuse With Dinner","Winter Special","BOOK PACKAGE","Rs 24000/-","package2.jpg"};
    String[] package3 = {"BRONZE PACKAGE", "6  Days and 7 Nights", "Return Airfare"," Free Clubbing , Horse Riddng  & other games","River Aftering","Hard Drinks Free","Daily Buffet","BBQ Dinner","Winter Special","BOOK PACKAGE","Rs 32000/-","package3.jpg"};
        
        

        JTabbedPane tab = new JTabbedPane();
//        tab.setBounds(0, 0, 900, 600);  useless
