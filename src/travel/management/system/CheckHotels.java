...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        String[] text = new String[]{"JW Marriott Hotel", "Madarin Oriental Hotel", "Four Seasons Hotels", "Raddission Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotels", "Happy Morining Motel", "River View Hotel"};
